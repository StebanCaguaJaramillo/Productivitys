                                    ...
                                    <div class="card-body">
										...
										?>">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <button type ="submit" class="btn btn-primary">Ingreso</button></div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="register.html">No tienes ususario? Registrate!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
